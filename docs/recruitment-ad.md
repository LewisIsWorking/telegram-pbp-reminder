...
Written 2026-08-25. The venue rotation (`scripts/recruiting/`) answers *where*.
This answers *what to actually post*.

## ⭐ The first two lines must answer "why Telegram"

PF2e play-by-post **on Telegram** is a narrow ask. General LFG boards are mostly
people looking for a live voice game, and even the play-by-post regulars are
mostly forum people. An advert that opens with the campaign premise is answering
a question nobody asked yet: the reader's first question is *"why is this in a
chat app?"*, and if the first two lines do not answer it they stop reading.

So the premise goes **third**. Lines one and two earn the right to it.
...
player message the GM has not replied to, posts the backlog publicly, and nags
him about it. Players can run `/waiting` and see what they are owed.

That is unusual, it is verifiable the moment they join, and it speaks directly
to the fear that stops people applying. **Lead on it.**
...
>
> It is not a forum you have to remember to visit, and combat runs in **Foundry
...
> A bot tracks every message the GM has not answered, posts the backlog where
> everyone can see it, and chases him. Type `/waiting` and it tells you exactly
> what you are owed. It also runs transcripts, a player-of-the-week vote, hero
...
⚠️ Verify the sticky or pinned rules at each forum before the first post there.
Every cooldown in the catalogue except r/lfg's is a **guess**.
