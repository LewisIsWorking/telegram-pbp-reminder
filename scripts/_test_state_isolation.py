...
from posting import sent_by_chat as _sbc
...
# sent_by_chat, added 2026-09-22: bot-sent IDs for chats other than the
# main group. Every routed notification writes here.
_sbc._store = _TEST_STORE
